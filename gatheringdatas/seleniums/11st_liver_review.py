...
#open chrome browser
browser = webdriver.Chrome(executable_path='C:/Users/01-09/Develops/chromedriver.exe', options=options) #webdriver_selenium과 web을 연결해주기위함.
...
## final 간 영양제 
browser.get('https://search.11st.co.kr/pc/total-search?kwd=%25EA%25B0%2584%2520%25EC%2598%2581%25EC%2596%2591%25EC%25A0%259C&tabId=TOTAL_SEARCH')
        ...
        for i in range(1, 61):  # 1부터 60까지 순회합니다.
            try:
                ...
                if review_total_count != 0:
                    ...
                    len(reviews_bundle)
                    ## 리뷰 리스트
                    liver_product_columns_name = ['product_name','review_content', 'review_date', 'review_star', 'review_writer']
                    reviews_list = list()
                    ...
                    df_reviews = pd.DataFrame(data=reviews_list, columns=liver_product_columns_name)
